...
{
  G4double pH = 7;    //Creation of pH and temperature variables
  ...
  runManager->SetUserInitialization(new DetectorConstruction(T)); //instances of classes PhysicsList and DetectorConstruction are called with modified constructors that take as input T and pH
