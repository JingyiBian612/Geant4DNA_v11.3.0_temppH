...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo.....
 ...
 DetectorConstruction::DetectorConstruction(G4double T) : G4VUserDetectorConstruction(), Temperature(T) {} //Implementation of a constructor that takes temperature as input and initializes variable temperature
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  //Setting temperature-dependent water density
  double t = Temperature - 273.15;  //t in Celsius
  double rho = 0.999 + 1.094e-4*t - 7.397e-6*pow(t,2) + 2.693e-8*pow(t,3) - 4.714e-11*pow(t,4);
  double density = rho * g/cm3; //Temperature-dependent density polynomial to create water material at different temperatures

  // Water is defined from NIST material database
  G4NistManager* man = G4NistManager::Instance();
  //G4Material* water = man->FindOrBuildMaterial("G4_WATER");
  G4Material* water =man->BuildMaterialWithNewDensity("G4_WATER_MODIFIED","G4_WATER",density); //use modified water density
