...
#include "globals.hh"
#include "G4ChemDissociationChannels_option1.hh" //Enger lab
...
class PhysicsList : public G4VModularPhysicsList
{
  public:
    ...
    explicit PhysicsList(G4double T, G4double P); //Definition of  constructor that takes temperature and pH as input.
