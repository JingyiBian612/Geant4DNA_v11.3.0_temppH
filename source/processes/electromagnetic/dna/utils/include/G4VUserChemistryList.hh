...
public:
  ...
  virtual void ConstructReactionTablePhTemp(G4DNAMolecularReactionTable* /*reactiontable*/, double /*T*/, double /*P*/) {} //Definition of virtual void ConstructReactionTablePhTemp
